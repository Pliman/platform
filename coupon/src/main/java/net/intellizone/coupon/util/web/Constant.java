...
public class Constant {
	...
	public static final String RC_PIC_PATH="\\goodsImg\\erwei";
	public static final String YQ_PIC_PATH="\\goodsImg\\yqimg";
	//图片上传路径
	...
	//图片默认大小 单位kb
	public static final int IMAGE_SIZE = Integer.parseInt(ConfigUtil.getInstance(SYS_CONFIG_PATH).getKeyValue("upImg_Size"));
	//日期格式
