package net.intellizone.coupon.lucene;
...
public class Indexer {
	private static String indexPath = "C:/goods";//索引存放目录 
    /**
     * @param args
     */
...
//            }
            ...
            writer.deleteAll();
            Scanner scanner = new Scanner(new FileInputStream("C:/goods/d.txt"), "UTF-8");
    try {
      int ii=0;
