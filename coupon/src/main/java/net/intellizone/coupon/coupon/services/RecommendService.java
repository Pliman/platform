...
public class RecommendService {
	...
	public List<Shop> getShopByHotList() {
		...
		List<Shop> hotshopList = dao.query(Shop.class,Cnd.where("is_hot", "=", 1).and("isverified","=",1),null);
	...
	public List<Shop> getShopByRecommendList() {
		...
		List<Shop> recomshopList = dao.query(Shop.class,Cnd.where("isremmend", "=", 1).and("isverified","=",1),null);
	...
	public  List<Goods> getRecommendCoupon(){
		 ...
		 List<Goods> recomGoodsList = dao.query(Goods.class,Cnd.where("is_recommend", "=", 1).and("isverified","=",1),null);
	...
	public  List<Activity> getRecommendActivity(){
		 ...
		 List<Activity> recomActivityList = dao.query(Activity.class,Cnd.where("is_recommend", "=", 1).and("isverified","=",1),null);
