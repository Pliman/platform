...
* Date:2009-11-23 
* Modules: grid.base.js; jquery.fmatter.js; grid.common.js; grid.formedit.js; jquery.searchFilter.js; grid.treegrid.js; 
*/
(function ($) {
	$.jgrid = $.jgrid || {};
	...
	$.fn.jqGrid = function (pin) {
		...
		return this.each(function () {
			...
			var sortkeys = ["shiftKey", "altKey", "ctrlKey"], IntNum = function (val, defval) {
				...
				if (ts.p.pginput === true) {
					pginp = "<td dir='" + dir + "' class='ui-paging-total'>" + $.jgrid.format(ts.p.pgtext || "", "<input class='ui-pg-input' type='text' size='2' maxlength='7' value='0' role='textbox'/>", "<span id='sp_1'></span>") + "</td>";
				}
				if (ts.p.pgbuttons === true) {
